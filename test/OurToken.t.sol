...
contract OurTokenTest is StdCheats, Test {
    ...
    function testTransfer() public {
        uint256 transferAmount = ourToken.balanceOf(address(this));
    ...
    function testTransferFrom() public {
        ...
        assertEq(
            ...
            initialBalanceAlice + transferAmount
        );
        assertEq(ourToken.balanceOf(bob), initialBalanceBob - transferAmount);
    }
}
